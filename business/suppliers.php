...
elseif($action =='insert_point')
{
    $sql = "INSERT INTO " .$hhs->table('shipping_point').
            " (shop_name, address,longitude,latitude,tel,suppliers_id) ".
            "VALUES".
            " ('$_POST[shop_name]','$_POST[address]','$_POST[longitude]','$_POST[latitude]','$_POST[tel]' ,'$suppliers_id')";
	$db->query($sql);
		show_message('添加自提点成功');
}
