...
function get_cat_piclist_goods(value) 
{
	...
	getStatusUrl = 'suppliers.php?act=get_cat_piclist_goods&cat_id='+value;
...
function get_cat_piclist(value)
{
	...
	getStatusUrl = 'suppliers.php?act=get_cat_piclist&cat_id='+value;
