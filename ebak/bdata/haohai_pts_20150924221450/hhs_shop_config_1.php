...
E_D("replace into `hhs_shop_config` values('101','1','shop_name','text','','','昊海软件 【测试-网站演示专用】','1');");
E_D("replace into `hhs_shop_config` values('102','1','shop_title','text','','','昊海软件 【测试-网站演示专用】','1');");
E_D("replace into `hhs_shop_config` values('103','1','shop_desc','text','','','乐田商城，优质水果新鲜直供，大家一起来玩吧！','1');");
E_D("replace into `hhs_shop_config` values('104','1','shop_keywords','text','','','昊海软件','1');");
...
E_D("replace into `hhs_shop_config` values('910','1','bonus_par','text','','','10,5,3,2,1','1');");
E_D("replace into `hhs_shop_config` values('911','6','default_shipping_id','hidden','','','5','1');");
...
E_D("replace into `hhs_shop_config` values('106','1','shop_province','manual','','','2','1');");
E_D("replace into `hhs_shop_config` values('107','1','shop_city','manual','','','52','1');");
