...
E_D("replace into `hhs_share_info` values('68','469','http://pts.hostadmin.com.cn/goods.php?id=37','1','1','1446622544');");
E_D("replace into `hhs_share_info` values('69','470','http://pts.hostadmin.com.cn/index.php','1','1','1446672685');");
E_D("replace into `hhs_share_info` values('70','480','http://pts.hostadmin.com.cn/goods.php?id=46','2','2','1446691041');");
E_D("replace into `hhs_share_info` values('71','501','http://pts.hostadmin.com.cn/index.php','1','1','1447012847');");
E_D("replace into `hhs_share_info` values('72','506','http://pts.hostadmin.com.cn/share.php?team_sign=398','1','1','1447026081');");
E_D("replace into `hhs_share_info` values('73','321','http://pts.hostadmin.com.cn/share_pay.php?showwxpaytitle=1&id=403','1','1','1447064026');");
E_D("replace into `hhs_share_info` values('74','465','http://pts.hostadmin.com.cn/index.php','1','2','1447106913');");
E_D("replace into `hhs_share_info` values('75','513','http://pts.hostadmin.com.cn/share.php?team_sign=407','1','1','1447124641');");
