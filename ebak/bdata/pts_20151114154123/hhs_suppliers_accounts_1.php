...
E_C("CREATE TABLE `hhs_suppliers_accounts` (
  ...
  `remark` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=126 DEFAULT CHARSET=utf8 COMMENT='商家结算'");
...
E_D("replace into `hhs_suppliers_accounts` values('125','463','4.10','1','','','1447117438','0.00','','2015111087806',NULL);");
