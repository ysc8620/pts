...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    /* 处理上传的LOGO图片 */
        ...
        /* 插入数据 */
        $sql    = "INSERT INTO ".$hhs->table('site')." (close,name, city_id, site_logo, keywords,description) ".
                  "VALUES ('$close','$name', '$city_id', '$site_logo', '$keywords','$description')";
        $db->query($sql);
