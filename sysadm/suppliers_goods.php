...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $hhs->table('goods') . " (district_id,city_id,is_nearby,sales_num,little_img,team_num,team_price,goods_name, goods_name_style, goods_sn, " .
                ...
                "VALUES ('$district_id','$city_id','$is_nearby','$sales_num','$little_img','$team_num','$team_price','$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
...
elseif ($_REQUEST['act'] == 'check') {
    ...
    if ($rows) {
        ...
        if ($is_email == 'on') {
            if ($is_check == 0) {
                $content = '尊敬的珍佰商家，您的商品正在审核中，请耐心等待！' . $desc;
            }
            if ($is_check == 1) {

                $content = '尊敬的珍佰商家，您提交的商品申请已审核通过！备注信息：' . $desc;
            }
            if ($is_check == 2) {
                $content = '尊敬的珍佰商家，您的商品未通过审核，详情请致电客服' . $_CFG['service_phone'] . '' . $desc;
            }
        ...
        if ($is_sms == 'on') {
            ...
            if ($is_check == 1) {
                $content = '尊敬的珍佰商家，您提交的商品申请已审核通过!' . $desc;
            }
            if ($is_check == 2) {
                $content = '尊敬的珍佰商家，您的商品未通过审核，详情请致电客服 ' . $_CFG['service_phone'] . ' ' . $desc;
            }
...
{
    $href = 'suppliers_goods.php?act=list';
