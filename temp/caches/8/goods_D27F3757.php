<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:60:"/phpstudy/www/pts.hostadmin.com.cn/themes/haohaios/goods.dwt";i:1;s:69:"/phpstudy/www/pts.hostadmin.com.cn/themes/haohaios/library/footer.lbi";}s:7:"expires";i:1447254250;s:8:"maketime";i:1447250650;}<!doctype html>
<html lang="zh-CN">
<head>
...
<div class="container">
    <section class="main-view">
        ...
        <div class="tm">
            <form action="javascript:addToCart(52)" method="post" name="HHS_FORMBUY" id="HHS_FORMBUY" >
            <div class="td2">
                <div class="td2_name">【测试商品-网站演示专用】商家商品11</div>
                <div class="td2_cx"></div>
                <div class="td2_info">
                    <div class="td2_price">市场价：¥<b>0.00</b> <span>已售：104件</span></div>
                    <div class="td2_num">支付开团并邀请<span>0</span>人参团，人数不足自动退款，详见下方拼团玩法</div>
                </div>
            </div>
      ...
      <ul>
            ...
            <div class="kt">
                <a class="kt_item" style="margin-right:2%" href="javascript:addToCart(52,0,0,5)">
                    <div class="kt_price">¥<b id="tuan_more_price">1.00</b><i> / </i>件</div>
                    <div class="kt_btn"><b id="tuan_more_number">1人团</b></div>
                </a>
                <a class="kt_item kt_item_buy" href="javascript:addToCart(52);">
                    <div class="kt_price">¥<b>0.02</b><i> / </i>件</div>
                    <div class="kt_btn">单独购买</div>
                </a>
            </div>
                        <div class="back-index" ms-if="isShow_btn">
                <a href="GroupPurchase.php?goods_id=52">附近的团  <i class="fa fa-map-marker"></i></a>
            </div> 
                        </form>
        </div>
        <div class="pro-detial">
            ...
            <div class="pro_con">
                <div id="con_one_1">大家快来买了<br /></div>
            </div>
        </div>
        <div class="step">
            <div class="step_hd">
...
<script language="javascript" type="text/javascript">
	wx.config({
	    ...
	    timestamp: '1447250650',//这个一定要与上面的php代码里的一样。
	    nonceStr: '1447250650',//这个一定要与上面的php代码里的一样。
	    signature: 'da2b4d99319b862d8bfd26332570830510dc0de3',
	    jsApiList: [
	...
	var title="【测试商品-网站演示专用】商家商品11";
	var link= "http://pts.hostadmin.com.cn/goods.php?id=52";
	var imgUrl="http://pts.hostadmin.com.cn/business/uploads/463/20150805100647fxsaidgr.jpg";
	...
	function statis(share_type,share_status){
		$.ajax({
            ...
            data:"act=link&share_status="+share_status+"&share_type="+share_type+"&link_url=http%3A%2F%2Fpts.hostadmin.com.cn%2Fgoods.php%3Fid%3D52",
            dataType:"json",//服务器返回结果类型(可有可无)
            error:function(){//错误处理函数(可有可无)
                //alert("ajax出错啦");
            },
