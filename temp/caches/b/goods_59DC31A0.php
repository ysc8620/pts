<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:60:"/phpstudy/www/pts.hostadmin.com.cn/themes/haohaios/goods.dwt";i:1;s:69:"/phpstudy/www/pts.hostadmin.com.cn/themes/haohaios/library/footer.lbi";}s:7:"expires";i:1447254141;s:8:"maketime";i:1447250541;}<!doctype html>
<html lang="zh-CN">
<head>
...
<div class="container">
    <section class="main-view">
        <div class="flexslider" style="margin-bottom:10px;">
            <ul class="slides">
                                <li><img src="images/201507/goods_img/45_P_1437624172368.jpg"/></li>
                            </ul>
        </div>
        ...
        <div class="tm">
            <form action="javascript:addToCart(45)" method="post" name="HHS_FORMBUY" id="HHS_FORMBUY" >
            <div class="td2">
                <div class="td2_name">【测试商品-网站演示专用】 抹茶</div>
                <div class="td2_cx"></div>
                <div class="td2_info">
                    <div class="td2_price">市场价：¥<b>144.00</b> <span>已售：0件</span></div>
      ...
      <ul>
            ...
            <div class="kt">
                <a class="kt_item" style="margin-right:2%" href="javascript:addToCart(45,0,0,5)">
                    <div class="kt_price">¥<b id="tuan_more_price">1.20</b><i> / </i>件</div>
                    <div class="kt_btn"><b id="tuan_more_number">5人团</b></div>
                </a>
                <a class="kt_item kt_item_buy" href="javascript:addToCart(45);">
                    <div class="kt_price">¥<b>120.00</b><i> / </i>件</div>
                    <div class="kt_btn">单独购买</div>
                </a>
            </div>
                        <div class="back-index" ms-if="isShow_btn">
                <a href="GroupPurchase.php?goods_id=45">附近的团  <i class="fa fa-map-marker"></i></a>
            </div> 
                        </form>
        </div>
...
<script language="javascript" type="text/javascript">
	wx.config({
	    ...
	    timestamp: '1447250543',//这个一定要与上面的php代码里的一样。
	    nonceStr: '1447250543',//这个一定要与上面的php代码里的一样。
	    signature: '784372c107559dd0c2826f0c51df78a1e45c5c6b',
	    jsApiList: [
	...
	var title="【测试商品-网站演示专用】 抹茶";
	var link= "http://pts.hostadmin.com.cn/goods.php?id=45";
	var imgUrl="http://pts.hostadmin.com.cn/images/201507/thumb_img/45_thumb_G_1437624172207.jpg";
	...
	function statis(share_type,share_status){
		$.ajax({
            ...
            data:"act=link&share_status="+share_status+"&share_type="+share_type+"&link_url=http%3A%2F%2Fpts.hostadmin.com.cn%2Fgoods.php%3Fid%3D45",
            dataType:"json",//服务器返回结果类型(可有可无)
            error:function(){//错误处理函数(可有可无)
                //alert("ajax出错啦");
            },
