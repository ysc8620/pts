...
?>
    <tr>
      <td align="center"><span><input value="<?php echo $this->_var['bonus']['bonus_id']; ?>" name="checkboxes[]" type="checkbox"><?php echo $this->_var['bonus']['bonus_id']; ?></span></td>
      <?php if ($this->_var['show_bonus_sn']): ?>
      <td align="center"><?php echo $this->_var['bonus']['bonus_sn']; ?></td>
      <?php endif; ?>
      <td align="center"><?php echo $this->_var['bonus']['type_name']; ?></td>
      <td align="center"><?php echo $this->_var['bonus']['order_sn']; ?></td>
      <td align="center"><?php if ($this->_var['bonus']['email']): ?><a href="mailto:<?php echo $this->_var['bonus']['email']; ?>"><?php echo $this->_var['bonus']['user_name']; ?></a><?php else: ?><?php echo $this->_var['bonus']['user_name']; ?><?php endif; ?></td>
      <td align="center"><?php echo $this->_var['bonus']['used_time']; ?></td>
      <?php if ($this->_var['show_mail']): ?>
