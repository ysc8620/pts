...
<table width="100%">
  ...
  <tr>
    <td class="label"><a href="javascript:showNotice('NoticeIsShare');" title="<?php echo $this->_var['lang']['form_notice']; ?>"> <img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>" /></a><?php echo $this->_var['lang']['is_share']; ?></td>
    <td>
      <input type="radio" name="is_share" value="0" <?php if ($this->_var['bonus_arr']['is_share'] != 1): ?> checked="true" <?php endif; ?> onclick="document.getElementById('number_tr').style.display='none';"  /><?php echo $this->_var['lang']['share_by']['0']; ?>
      <input type="radio" name="is_share" value="1" <?php if ($this->_var['bonus_arr']['is_share'] == 1): ?> checked="true" <?php endif; ?>  onclick="document.getElementById('number_tr').style.display='';"  /><?php echo $this->_var['lang']['share_by']['1']; ?>
      <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="NoticeIsShare">设置为好友券必须分享给好友使用</span> 
    </td>
  </tr>
  <!-- 
  <tr id="amount_tr" <?php if ($this->_var['bonus_arr']['is_share'] != 1): ?> style="display:none" <?php endif; ?> >
   ...
   -->
  <tr id="number_tr" <?php if ($this->_var['bonus_arr']['is_share'] != 1): ?> style="display:none" <?php endif; ?>>
    <td class="label">发放优惠券的数量</td>
    <td>
    	<input type="text" value="<?php echo $this->_var['bonus_arr']['number']; ?>" name="number"  >
    </td>
  </tr>
