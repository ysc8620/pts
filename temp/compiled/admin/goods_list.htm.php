...
?>
  <tr>
    ...
    <td align="center" class="first-cell" style="<?php if ($this->_var['goods']['is_promote']): ?>color:red;<?php endif; ?>"><span onclick="listTable.edit(this, 'edit_goods_name', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></span><?php if ($this->_var['goods']['limit_buy_one'] == 1): ?><font style="color:#F00;">[限购]<?php endif; ?></font></td>
