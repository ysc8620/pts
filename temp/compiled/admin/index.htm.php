...
<table id="frametable" cellpadding="0" cellspacing="0" width="100%" height="100%">
    <tr>
        <td colspan="2" height="67" valign="top">
...
?>
                        ...
                        <li><h3><a href="privilege.php?act=logout"><i class="iconfont">&#xe60e;</i><?php echo $this->_var['lang']['signout']; ?></a></h3></li>
                    </ul>
                </div>
        </td>
    </tr>
        ...
        <td valign="top" width="130" class="menutd">
		    <div id="leftmenu" class="menu">
                <ul id="menu_index" style="display:none">
                    <li><a href="index.php?act=main" hidefocus="true" target="main"><?php echo $this->_var['lang']['admin_home']; ?></a></li>
...
?>
        ...
        <td valign="top" width="100%"><iframe src="index.php?act=main" id="main" name="main" width="100%" height="100%" frameborder="0" scrolling="yes"></iframe></td>
    </tr>
</table>
<div class="copyright"><a href="index.php?act=about_us" target="main">© haohaios.com</a></div>
