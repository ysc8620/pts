...
<?php echo $this->smarty_insert_scripts(array('files'=>'topbar.js,../js/utils.js,listtable.js,selectzone.js,.common.js')); ?>
...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td><div align="right"><strong>   公司类别：</div></td>
...
<table width="100%" cellpadding="3" cellspacing="1">
  <tr>
    <th colspan="7" scope="col"><?php echo $this->_var['lang']['goods_info']; ?><!--<a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=goods" class="special"><?php echo $this->_var['lang']['edit']; ?></a>--></th>
    </tr>
  <tr>
...
- <?php echo $this->_var['lang']['label_discount']; ?><strong><?php echo $this->_var['order']['formated_discount']; ?></strong>    
  ...
  <tr>
    ...
    <td colspan="5"><?php if ($this->_var['operable_list']['confirm']): ?>
      <input name="confirm" type="submit" value="<?php echo $this->_var['lang']['op_confirm']; ?>" class="button" />
        ...
        <input name="refund" type="submit" value="退款" class="button" onClick="return window.confirm('你确定要退款吗');" />
        <?php endif; ?>
