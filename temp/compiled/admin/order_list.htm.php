...
?>
  <tr>
    ...
    <td align="center" valign="top"><a href="mailto:<?php echo $this->_var['order']['email']; ?>"> [<?php echo $this->_var['order']['region']; ?>]<?php echo htmlspecialchars($this->_var['order']['consignee']); ?></a><?php if ($this->_var['order']['tel']): ?> [TEL: <?php echo htmlspecialchars($this->_var['order']['tel']); ?>]<?php endif; ?> <br /><?php echo htmlspecialchars($this->_var['order']['address']); ?></td>
   ...
   <td align="center" valign="top" nowrap="nowrap"><?php if ($this->_var['order']['extension_code'] == 'team_goods'): ?>团购【<?php echo $this->_var['lang']['team_status'][$this->_var['order']['team_status']]; ?>】<?php else: ?>单独购买<?php endif; ?></td>
