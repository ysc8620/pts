...
<div class="form-div">
  <form action="javascript:search_supp()" name="searchForm">
   ...
   <?php if ($_SESSION['site_id'] == ''): ?>
    &nbsp;&nbsp;站点：&nbsp;&nbsp;<select name="site_id" id='site_id'>
    <option value="">请选择</option>
    <!-- <?php $_from = $this->_var['site_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'site');if (count($_from)):
    foreach ($_from AS $this->_var['site']):
?> -->
      <option value="<?php echo $this->_var['site']['id']; ?>"><?php echo $this->_var['site']['name']; ?></option>
    ...
    &nbsp;&nbsp;
       商城一楼：&nbsp;&nbsp;
    <select name="is_oneshow" id='is_oneshow'>
    <option value="">请选择</option>
    ...
    <option value="2">否</option>
       ...
       商城二楼：&nbsp;&nbsp;
    <select name="is_twoshow" id='is_twoshow'>
    <option value="">请选择</option>
   <option value="1">是</option>
    <option value="2">否</option>
    </select>
 ...
 推荐人
    ...
    <input type="text" name="recommend_type_name" id='recommend_type_name'  size="15" />
    <!-- <?php endif; ?> -->
...
?>
    <tr>
      ...
      <td align="center" class="first-cell"><?php if ($this->_var['suppliers']['recommend_person']): ?><?php echo $this->_var['suppliers']['recommend_person']; ?><?php else: ?>无<?php endif; ?></td>
   
      <td align="center" ><?php echo $this->_var['suppliers']['phone']; ?></td>
      <td align="center" ><?php echo $this->_var['suppliers']['email']; ?></td>
     ...
     -->
      ...
      <?php if ($this->_var['suppliers']['is_check'] == 0): ?>审核中&nbsp;&nbsp;<a href="suppliers.php?act=check&id=<?php echo $this->_var['suppliers']['suppliers_id']; ?>&is_check=0&page=<?php echo $this->_var['filter']['page']; ?>">立即审核</a><?php endif; ?>
       <?php if ($this->_var['suppliers']['is_check'] == 2): ?>未通过&nbsp;&nbsp;<a href="suppliers.php?act=check&id=<?php echo $this->_var['suppliers']['suppliers_id']; ?>&is_check=2&page=<?php echo $this->_var['filter']['page']; ?>">继续审核</a><?php endif; ?>
      </td>
      <!-- 
      ...
      <td align="center">
<a href="goods.php?act=list&suppliers_id=<?php echo $this->_var['suppliers']['suppliers_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>">商品</a> |
        ...
        <a href="suppliers.php?act=trademark&id=<?php echo $this->_var['suppliers']['suppliers_id']; ?>" title="商标">商标</a> |
         -->
        <a href="javascript:void(0);" onclick="listTable.remove(<?php echo $this->_var['suppliers']['suppliers_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><?php echo $this->_var['lang']['remove']; ?></a>  |<a href="suppliers.php?act=suppliers_accounts&suppliers_id=<?php echo $this->_var['suppliers']['suppliers_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>">结算</a>     </td>
