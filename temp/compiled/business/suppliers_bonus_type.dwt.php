...
<?php if ($this->_var['action'] == 'bonus_list'): ?>
  <div class="main" id="main">
        ...
        <div class="maincon">
		  ...
		  <div class="conbox">
          <form method="POST" action="suppliers.php?act=bonus_batch&bonus_type=<?php echo $_GET['bonus_type']; ?>" name="listForm">
...
?>
    <tr>
      ...
      <?php endif; ?>
      <td align="center">
        <a href="suppliers.php?act=delete_bonus_list&bonus_id=<?php echo $this->_var['bonus']['bonus_id']; ?>&bonus_type=<?php echo $_GET['bonus_type']; ?>&page=<?php echo $this->_var['pager']['page']; ?>" onclick="return confirm('确定要此操作吗');" >移除</a>
...
只有商品总金额达到这个数的订单才能使用这种优惠劵 </td>
  ...
  <tr>
    ...
    <td>
      <input type="radio" name="send_type" onclick="show_hide(0);" value="1" <?php if ($this->_var['bonus_arr']['send_type'] == 1): ?> checked="true" <?php endif; ?>   /><?php echo $this->_var['lang']['send_by']['1']; ?>
      <input type="radio" name="send_type" onclick="show_hide(1);" value="3" <?php if ($this->_var['bonus_arr']['send_type'] == 3): ?> checked="true" <?php endif; ?>  /><?php echo $this->_var['lang']['send_by']['3']; ?>    </td>
  </tr>
    ...
    <tr>
      ...
      <td>
       <?php if ($this->_var['type']['send_type'] == 3): ?>
        <a href="suppliers.php?act=gen_bonus_excel&tid=<?php echo $this->_var['type']['type_id']; ?>"><?php echo $this->_var['lang']['report_form']; ?></a> |
        <?php endif; ?>
        <?php if ($this->_var['type']['send_type'] != 2): ?>
        <a href="suppliers.php?act=send_bonus&amp;id=<?php echo $this->_var['type']['type_id']; ?>&amp;send_by=<?php echo $this->_var['type']['send_type']; ?>"><?php echo $this->_var['lang']['send']; ?></a> |
        <?php endif; ?>
        <a href="suppliers.php?act=bonus_list&amp;bonus_type=<?php echo $this->_var['type']['type_id']; ?>"><?php echo $this->_var['lang']['view']; ?></a> |
        <a href="suppliers.php?act=edit_bonus&amp;type_id=<?php echo $this->_var['type']['type_id']; ?>"><?php echo $this->_var['lang']['edit']; ?></a> |
        <a href="suppliers.php?act=delete_bonus&amp;type_id=<?php echo $this->_var['type']['type_id']; ?>" onclick="return confirm('确定要此操作吗');">移除</a></span></td>
 </td> 
    </tr>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  </table>
