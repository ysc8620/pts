...
'account_deposit', 'account_log', 'account_detail', 'act_account', 'pay', 'default', 'bonus', 'group_buy', 'group_buy_detail', 'affiliate', 'comment_list','validate_email','track_packages', 'transform_points','qpassword_name', 'get_passwd_question', 'check_answer', 'refund', 'act_refund');
...
elseif ($action == 'order_list')
{
    ...
    {
        $where = " and order_status in (0,1,5) and pay_status=2 and shipping_status<>2 ";
    }
